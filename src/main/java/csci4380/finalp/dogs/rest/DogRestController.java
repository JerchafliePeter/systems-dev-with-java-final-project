...
public class DogRestController {
	...
	public String echoMessage(@RequestParam(value="msg", defaultValue="Hello, echoMessage works!") String message) {
	...
	/*
	@GetMapping("/findByTypeIgnoreCaseQuery/{dogType}")
    public  Optional<List<Dog>> findByTypeIgnoreCaseQuery(@PathVariable String dogType) {
        Optional<List<Dog>> dogs = dogRepository.findByTypeIgnoreCase(dogType);
        return dogs;
    }
    */
	@GetMapping("/findByType/{dogType}" )
	public List<Dog> findByType(@PathVariable String dogType) {
	List<Dog> dogs =dogRepository.findByType(dogType);
	return dogs;
	}
