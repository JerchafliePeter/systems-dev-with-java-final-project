...
public class CatRestController {
	...
	public Cat findByPetId(@PathVariable Integer petId) {
		Cat cats = catRepository.findByPetId(petId);
		return cats;
	}
    ...
    public  Optional<List<Cat>> findByTypeIgnoreCaseQuery(@PathVariable String catType) {
        Optional<List<Cat>> cats = catRepository.findByTypeAllIgnoreCase(catType);
        return cats;
    }
}
